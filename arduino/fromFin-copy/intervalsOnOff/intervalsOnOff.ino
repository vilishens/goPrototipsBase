...
// #include <Ticker.h> WeMos R1 D2 (ESP2866)
#include <time.h>
#include <TimeAlarms.h>

//#include <sys/sysinfo.h>

#define FIRST_DURATION_SECS             10  // 1.darbības intervāls sekundēs (ieslēgts)
#define FIRST_DELAY_DURATION_SECS       3   // 1.darbības nogaidīšana sekundēs (izslēgts)
#define SECOND_DURATION_SECS            5   // 2.darbības intervāls sekundēs (ieslēgts)
#define SECOND_DELAY_DURATION_SECS      2   // 2.darbības nogaidīšana sekundēs (izslēgts)
...
void logString(char *str, int len) {   
    ...
    snprintf(str, len, "#%4i# %9s *** %s *** %s \"%s\" (darbibas ilgums %3i; pin %2i; GPIO %2i) ---> %3s"
                            , cycleCount        
                            , nbrStr
                            , tm
                            , pointStr
